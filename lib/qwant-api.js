...
function getURL(keyword, count, offset, query, lang) { return `https://api.qwant.com/v3/search/${keyword}?count=${count}&q=${query}&t=${query}&f=&offset=${offset}&locale=${lang}&uiv=4`; }
